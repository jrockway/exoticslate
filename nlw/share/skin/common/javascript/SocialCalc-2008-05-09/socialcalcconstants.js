...
//
   ...
   defaultSkippedCellClass: "testclass", // used if present for spanned cells peeking into a pane (at least one of class/style needed)
   defaultSkippedCellStyle: "font-size:small;background-color:#CCC", // used if present
   defaultPaneDividerClass: "testclass", // used if present for the look of the space between panes (at least one of class/style needed)
...
//
   ...
   TCscrollareaStyle: "backgroundColor:#AAA;",
   TCscrollareaClass: "",
   TCscrollareaStyle: "backgroundColor:#AAA;",
