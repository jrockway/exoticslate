...
SocialCalc.SpreadsheetControl = function() {
   ...
   this.tabs.push({name: "edit", text: "Edit", html:
      ' <div id="%id.edittools">'+
      '  <input type="button" value="Undo" onclick="%s.DoCmd(this, \'undo\');" style="font-size:x-small;">'+
      '  <input type="button" value="Redo" onclick="%s.DoCmd(this, \'redo\');" style="font-size:x-small;">'+
      '  <input type="button" value="Copy" onclick="%s.DoCmd(this, \'copy\');" style="font-size:x-small;">'+
      '  <input type="button" value="Paste" onclick="%s.DoCmd(this, \'paste\');" style="font-size:x-small;">'+
      '  <input type="button" value="Fill Down" onclick="%s.DoCmd(this, \'filldown\');" style="font-size:x-small;">'+
      '  <input type="button" value="Fill Right" onclick="%s.DoCmd(this, \'fillright\');" style="font-size:x-small;">'+
      '  <input type="button" value="Erase" onclick="%s.DoCmd(this, \'erase\');" style="font-size:x-small;">'+
      ...
      '  <input type="button" value="OK" onclick="%s.DoCmd(this, \'ok-rowcolstuff\');" style="font-size:x-small;">'+
      ' </div>',
      onclick: null});
   ...
   this.tabs.push({name: "text", text: "Text", html:
      ...
      '    <div style="%tbt.">Reverse</div>'+
      '    <input type="button" value="On" onclick="%s.DoCmd(this, \'rev-on\');" style="font-size:x-small;">'+
      '    <input type="button" value="Off" onclick="%s.DoCmd(this, \'rev-off\');" style="font-size:x-small;">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:20px;">'+
      '    <div style="%tbt.">Wiki Text</div>'+
      '    <input type="button" value="On" onclick="%s.DoCmd(this, \'wiki-on\');" style="font-size:x-small;">'+
      '    <input type="button" value="Off" onclick="%s.DoCmd(this, \'wiki-off\');" style="font-size:x-small;">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:20px;">'+
      '    <div style="%tbt.">Align</div>'+
      '    <input type="button" value="Left" onclick="%s.DoCmd(this, \'align-left\');" style="font-size:x-small;">'+
      '    <input type="button" value="Center" onclick="%s.DoCmd(this, \'align-center\');" style="font-size:x-small;">'+
      '    <input type="button" value="Right" onclick="%s.DoCmd(this, \'align-right\');" style="font-size:x-small;">'+
      '    <input type="button" value="Default" onclick="%s.DoCmd(this, \'align-default\');" style="font-size:x-small;">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:4px;">'+
      '    <div style="%tbt.">More...</div>'+
      ...
      '     <input type="button" value="OK" onclick="%s.DoCmd(this, \'ok-text\');" style="font-size:x-small;">'+
      '   </td>'+
      '  </tr></table>'+
      ' </div>',
      onclick: null});
   ...
   this.tabs.push({name: "format", text: "Format", html:
      ...
      '  <table cellspacing="0" cellpadding="0"><tr>'+
      '   <td style="vertical-align:top;padding-right:20px;">'+
      '    <div style="%tbt.">Border</div>'+
      '    <input type="button" value="On" onclick="%s.DoCmd(this, \'borderon\');" style="font-size:x-small;">'+
      '    <input type="button" value="Off" onclick="%s.DoCmd(this, \'borderoff\');" style="font-size:x-small;">'+
      '   </td>'+
      '   <td style="vertical-align:top;padding-right:20px;">'+
      '    <div style="%tbt.">Merge Cells</div>'+
      '    <input type="button" value="Merge" onclick="%s.DoCmd(this, \'merge\');" style="font-size:x-small;">'+
      '    <input type="button" value="Unmerge" onclick="%s.DoCmd(this, \'unmerge\');" style="font-size:x-small;">'+
      '   </td>'+
      '  </tr></table>'+
      ' </div>',
      onclick: null});
   ...
   this.views["clipboard"] = {name: "clipboard", html:
      ...
      ' <input type="button" value="Export Clipboard" style="font-size:x-small;" onclick="%s.SpreadsheetControlClipboardExport();"><br>'+
      ' <textarea id="%id.clipboardtext" style="font-size:small;height:400px;width:800px;overflow:auto;" onfocus="%s.CmdGotFocus(this);"></textarea>'+
      '</div>'
      };
   ...
   this.tabs.push({name: "settings", text: "Settings", html:
...
//      onunclick: SocialCalc.SpreadsheetControlSettingsOnunclick
   ...
   this.views["settings"] = {name: "settings", values: {},
      ...
      html:
      '<div id="%id.settingsview" style="margin-right:10px;border:1px solid black;overflow:auto;">'+
'<table id="%id.sheetsettingstable" style="display:none;" cellspacing="0" cellpadding="0">'+
'<tr><td>&nbsp;</td><td %sectiontitle.>'+
' SHEET SETTINGS &nbsp; (<a href="" onclick="SocialCalc.SpreadsheetControlSettingsSwitch(\'cell\');return false;">CELL SETTINGS</a>)'+
'</td></tr>'+
'<tr><td>&nbsp;</td><td>'+
' <br><input id="%id.settings-savesheet" type="button" value="Save" onclick="SocialCalc.SetttingsControlSave(\'sheet\');">'+
'</td></tr>'+
'<tr>'+
...
'     <input id="%id.padtop-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Right</div>'+
'     <select id="%id.padright-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.padright-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Bottom</div>'+
'     <select id="%id.padbottom-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.padbottom-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Left</div>'+
'     <select id="%id.padleft-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.padleft-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'   </tr></table>'+
' </td>'+
'</tr>'+
'<tr>'+
' <td %itemtitle.><br>Column Width:</td>'+
' <td %itembody.>'+
'   <table cellspacing="0" cellpadding="0"><tr>'+
'    <td %bodypart.>'+
'     <div %parttitle.>&nbsp;</div>'+
...
'<tr><td>&nbsp;</td><td %sectiontitle.>'+
' CELL SETTINGS: <span id="%id.settingsecell">&nbsp;</span> &nbsp; (<a href="" onclick="SocialCalc.SpreadsheetControlSettingsSwitch(\'sheet\');return false;">SHEET SETTINGS</a>)'+
'</td></tr>'+
'<tr><td>&nbsp;</td><td>'+
' <br><input id="%id.settings-savecell" type="button" value="Save" onclick="SocialCalc.SetttingsControlSave(\'cell\');">'+
'</td></tr>'+
'<tr>'+
' <td %itemtitle.><br>Format:</td>'+
' <td %itembody.>'+
...
'     <input id="%id.cpadtop-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Right</div>'+
'     <select id="%id.cpadright-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.cpadright-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Bottom</div>'+
'     <select id="%id.cpadbottom-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.cpadbottom-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'    <td %bodypart.>'+
'     <div %parttitle.>Left</div>'+
'     <select id="%id.cpadleft-dd" onchange="SocialCalc.SettingsControlOnchange(this);" size="1"></select>'+
'     <input id="%id.cpadleft-ib" onchange="SocialCalc.SettingsControlOnchange(this);" type="text" size="5" value="">'+
'    </td>'+
'   </tr></table>'+
' </td>'+
'</tr>'+
...
SocialCalc.InitializeSpreadsheetControl = function(spreadsheet, node, height, width) {
   ...
   var html, child, i, vname, v, style;
...
SocialCalc.SpreadsheetControlSettingsSwitch = function(target) {
   var s = SocialCalc.GetSpreadsheetControlObject();
   var sheetele = document.getElementById(s.idPrefix+"sheetsettingstable");
   var cellele = document.getElementById(s.idPrefix+"cellsettingstable");
   if (target=="sheet") {
      sheetele.style.display = "block";
      cellele.style.display = "none";
      SocialCalc.SettingsControlSetCurrentPanel(s.views.settings.values.sheetspanel);
      }
   else {
      sheetele.style.display = "none";
