...
sub process_request {
   ...
   if ($q->param("loadsheet")) { # Ajax request
...
<tr onmouseout="hide_buttons(!document.getElementById('showb').checked);"
        onmouseover="hide_buttons(false);"><td valign="top" id="sheet-$sheetname">$html</td>
...
<script type="text/javascript" src="/sgi/scjstest/socialcalc-3.js"></script>
<script type="text/javascript" src="/sgi/scjstest/socialcalctableeditor.js"></script>
<script type="text/javascript" src="/sgi/scjstest/formatnumber2.js"></script>
<script type="text/javascript" src="/sgi/scjstest/formula1.js"></script>
<script type="text/javascript" src="/sgi/scjstest/drawlib3.js"></script>
<script>
...
<script type="text/javascript" src="/sgi/scjstest/formatnumber2.js"></script>
<script type="text/javascript" src="/sgi/scjstest/formula1.js"></script>
<script type="text/javascript" src="/sgi/scjstest/socialcalcspreadsheetcontrol.js"></script>
<style>
body, td, input, texarea
 {font-family:verdana,helvetica,sans-serif;font-size:small;}
</style>
...
function loadsheet(sheetname) {
   var str = ajaxrequest("", "&loadsheet="+encodeURIComponent(sheetname));
   if (str) {
      return str;
      }
   else {
...
SocialCalc.Formula.SheetCache.loadsheet = function(sn) {return loadsheet(sn);};
...
function ajaxrequest(url, contents) {
   ...
   http_request.open('POST', document.URL, false);
   http_request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
   http_request.send(contents);
   var rstr = http_request.responseText;
   http_request = null;
   return rstr;
...
function dosave() {
   var sheetstr = spreadsheet.CreateSheetSave();
...
// start everything
   ...
   spreadsheet.editor.imageprefix="/sgi/scjstest/sc";
   spreadsheet.InitializeSpreadsheetControl("tableeditor");
   spreadsheet.ParseSheetSave(document.getElementById("sheetdata").value);
...
<META http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Simple Page Editor With Spreadsheets</title>
<script type="text/javascript" src="/sgi/scjstest/socialcalc-2.js"></script>
<script type="text/javascript" src="/sgi/scjstest/drawlib3.js"></script>
<style>
body, td, input, texarea
 {font-family:verdana,helvetica,sans-serif;font-size:small;}
