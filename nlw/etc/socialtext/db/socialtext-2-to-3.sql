...
-- It is possible but unlikely that this schema has already been created.
-- A migration (25-skip-guanxi-schema) will check for the schema already
-- existing, and then manually bump the schema version past this schema.
